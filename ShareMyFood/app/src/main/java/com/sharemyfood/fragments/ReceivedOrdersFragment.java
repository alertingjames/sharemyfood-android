...
public class ReceivedOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = (View)inflater.inflate(R.layout.fragment_received, container, false);
        init(view);
        return view;
    }
    ...
    void init(View view) {
        ...
        ///////////////////// UI VERSION /////////////////
        LinearLayout lin_order_container = (LinearLayout) view.findViewById(R.id.linear_Rorder_container);
        ...
        if(orderHistories.size() == 0){
            ((TextView) view.findViewById(R.id.tv_Rorderresult)).setVisibility(View.VISIBLE);
        } else {
            ((TextView) view.findViewById(R.id.tv_Rorderresult)).setVisibility(View.GONE);
        }
    }
    ...
    void onDelete(int index, LinearLayout lin, LinearLayout cell){
        ...
        txvLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                lin.removeView(cell);
                (new BaseActivity()).showToast("Recieved share history delect success");
            }
        });
