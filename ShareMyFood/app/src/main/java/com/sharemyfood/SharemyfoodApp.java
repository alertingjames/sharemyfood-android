...
public class SharemyfoodApp extends Application {
    public static final String TAG = SharemyfoodApp.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static SharemyfoodApp _instance;

    public static SharemyfoodApp getApplication() {
        return _instance;
    }
    ...
    public static synchronized SharemyfoodApp getInstance(){
